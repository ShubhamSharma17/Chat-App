...
class _ChatRoomPageState extends State<ChatRoomPage> {
  ...
  void sendMessage(){
    ...
    collection("messages").doc(msgModel.messageid).set(msgModel.toMap());
    // update last message
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title:Row(
          children: [
            CircleAvatar(backgroundImage: NetworkImage(widget.targetUser.profilepic!),),
                   ...
                   builder: (context, snapshot) {
                    if(snapshot.connectionState == ConnectionState.active){
                      ...
                      if(snapshot.hasData){
                        QuerySnapshot querySnapshot = snapshot.data as QuerySnapshot;
                         return ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return Row(
                              mainAxisAlignment: widget.userModel.uid == currentMessage.sender.toString()
                              ...
                              children: [
                                Container(
                                  ...
                                  decoration:  BoxDecoration(
                                    color:widget.userModel.uid == currentMessage.sender.toString()?gray939393 :blue,
                        ...
                        return const Center(
                          child: Text("An error occurred! Please check your internet"),);
                      }
                      else{
                        return const Center(
